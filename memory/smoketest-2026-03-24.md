...
**Run:** 2026-03-24 05:30:04 PDT
**Host:** Mac

## 1. Gateway Health

  Installed: OpenClaw 2026.3.23-2 (7ffe7e4)
  Latest available: 2026.3.23-2
  ⚠️  Update available: 2026.3.23 → 2026.3.23-2
  ✅ Gateway process running (pid 65549)
...
## 6. LLM Provider Health
  ...
  ✅ openai:default (openai): healthy, last used 7.6h ago
  ✅ grokheavy:default (grokheavy): healthy, last used never
  ✅ xai:default (xai): healthy, last used 22.4h ago
  ✅ LLM timeout: 180s (good — fast failover)
  ⚠️  16 LLM timeouts in recent logs
...
## 8. LaunchAgent Services
  ...
  ✅ ai.openclaw.gateway (exit=0, pid=65549)
...
**Health Score: 75/100** (18/24 checks passed, 4 warnings, 2 failures)

## 🔔 Action Items for Eric

1. [UPDATE] Run: npm install -g openclaw@latest (current: 2026.3.23, available: 2026.3.23-2)
2. [CRITICAL-OAUTH] Google token expired — run on MacBook: gog auth add ericfbrown1@gmail.com --services gmail,calendar,drive,contacts,docs,sheets --force-consent
3. [STABILITY] Frequent LLM timeouts detected (16) — may indicate provider issues or overloaded API
...
---
*Generated by OpenClaw Daily Smoke Test v1.0 at 2026-03-24 05:30:12 PDT*
