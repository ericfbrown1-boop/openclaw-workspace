...
**Run:** 2026-04-05 05:30:03 PDT
**Host:** Mac

## 1. Gateway Health

  Installed: OpenClaw 2026.4.2 (d74a122)
  Latest available: 2026.4.2
  ✅ OpenClaw is up to date
  ✅ Gateway process running (pid 51108)
...
## 3. Telegram Bot Health ⚡
  ...
  ✅ Telegram bot responding (2141ms)
...
## 6. LLM Provider Health
  ...
  ✅ anthropic:default (anthropic): healthy, last used 0.3h ago
  ✅ openai:default (openai): healthy, last used 197.8h ago
  ✅ grokheavy:default (grokheavy): healthy, last used never
  ✅ xai:default (xai): healthy, last used 34.6h ago
  ✅ LLM timeout: 180s (good — fast failover)
  ⚠️  64 LLM timeouts in recent logs
...
## 8. LaunchAgent Services
  ...
  ✅ ai.openclaw.gateway (exit=0, pid=51108)
...
**🆕 Newly tracked:**
- `main/skills/project-dynamo/SKILL.md`
...
2. [STABILITY] Frequent LLM timeouts detected (64) — may indicate provider issues or overloaded API
3. [SECURITY] 3 high-severity Dependabot alerts — review and patch

---
*Generated by OpenClaw Daily Smoke Test v1.0 at 2026-04-05 05:30:11 PDT*
