...
## 1. Gateway Health
  ...
  ⚠️  Update available: 2026.4.2 → 2026.4.5
  ✅ Gateway process running (pid 39520)
...
## 3. Telegram Bot Health ⚡
  ...
  ✅ Telegram bot responding (1024ms)
...
## 6. LLM Provider Health
  ...
  ✅ openai:default (openai): healthy, last used 221.8h ago
  ✅ grokheavy:default (grokheavy): healthy, last used never
  ✅ xai:default (xai): healthy, last used 58.6h ago
...
## 8. LaunchAgent Services
  ...
  ✅ ai.openclaw.gateway (exit=-15, pid=39520)
...
1. [UPDATE] Run: npm install -g openclaw@latest (current: 2026.4.2, available: 2026.4.5)
...
---
*Generated by OpenClaw Daily Smoke Test v1.0 at 2026-04-06 05:30:11 PDT*
