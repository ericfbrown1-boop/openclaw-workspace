...
**Run:** 2026-03-29 05:30:02 PDT
**Host:** Mac

## 1. Gateway Health

  Installed: OpenClaw 2026.3.24 (cff6dc9)
  Latest available: 2026.3.28
  ⚠️  Update available: 2026.3.24 → 2026.3.28
  ✅ Gateway process running (pid 89407)
...
## 6. LLM Provider Health
  ...
  ✅ openai:default (openai): healthy, last used 29.8h ago
  ✅ grokheavy:default (grokheavy): healthy, last used never
  ✅ xai:default (xai): healthy, last used 30.9h ago
  ✅ LLM timeout: 180s (good — fast failover)
  ⚠️  8 LLM timeouts in recent logs
...
## 8. LaunchAgent Services
  ...
  ✅ ai.openclaw.gateway (exit=0, pid=89407)
...
**📝 Modified:**
- `main/skills/financial-report-gen/SKILL.md` — updated 2026-03-28 05:48 (246 lines)
- `planner/AGENTS.md` — updated 2026-03-28 09:02 (59 lines)
- `coder/AGENTS.md` — updated 2026-03-28 09:02 (58 lines)
- `quality/AGENTS.md` — updated 2026-03-28 09:02 (90 lines)

**🆕 Newly tracked:**
- `main/skills/ai-legal-assistant/SKILL.md`
...
1. [UPDATE] Run: npm install -g openclaw@latest (current: 2026.3.24, available: 2026.3.28)
2. [MCP] Check Zapier MCP connection — run: mcporter list
3. [STABILITY] Frequent LLM timeouts detected (8) — may indicate provider issues or overloaded API
4. [SECURITY] 3 high-severity Dependabot alerts — review and patch
5. [AGENTS] Review agent configuration changes in the Agent Skills section above

---
*Generated by OpenClaw Daily Smoke Test v1.0 at 2026-03-29 05:30:10 PDT*
