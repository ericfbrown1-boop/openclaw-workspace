...
## 1. Gateway Health
  ...
  ⚠️  Update available: 2026.4.12 → 2026.4.14
  ✅ Gateway process running (pid 46503)
...
## 2. Tailscale Connectivity ⚡
  ...
  Online: True
  Peers:
    powerspecpc: 100.81.21.114 (⚪ offline)
...
/Users/ericbrown/.openclaw/workspace/scripts/daily_smoketest.sh: line 357: [: 0
0: integer expression expected
/Users/ericbrown/.openclaw/workspace/scripts/daily_smoketest.sh: line 360: [: 0
0: integer expression expected
  ✅ No LLM timeouts in recent logs
...
## 8. LaunchAgent Services
  ...
  ✅ ai.openclaw.gateway (exit=0, pid=46503)
...
1. [UPDATE] Run: npm install -g openclaw@latest (current: 2026.4.12, available: 2026.4.14)
...
---
*Generated by OpenClaw Daily Smoke Test v1.0 at 2026-04-15 05:30:15 PDT*
