...
**Run:** 2026-04-09 05:30:06 PDT
**Host:** Mac

## 1. Gateway Health

  Installed: OpenClaw 2026.4.8 (9ece252)
  Latest available: 2026.4.9
  ⚠️  Update available: 2026.4.8 → 2026.4.9
  ✅ Gateway process running (pid 38805)
...
## 6. LLM Provider Health
  ...
  ⚠️  29 LLM timeouts in recent logs
...
## 8. LaunchAgent Services
  ...
  ✅ ai.openclaw.gateway (exit=0, pid=38805)
...
1. [UPDATE] Run: npm install -g openclaw@latest (current: 2026.4.8, available: 2026.4.9)
...
5. [STABILITY] Frequent LLM timeouts detected (29) — may indicate provider issues or overloaded API

---
*Generated by OpenClaw Daily Smoke Test v1.0 at 2026-04-09 05:30:15 PDT*
