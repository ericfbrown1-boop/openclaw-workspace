...
## 3. Telegram Bot Health ⚡
  ...
  ✅ Telegram bot responding (2393ms)
...
## 6. LLM Provider Health
  ...
  ✅ anthropic:default (anthropic): healthy, last used 1.2h ago
  ✅ openai:default (openai): healthy, last used 174.1h ago
  ✅ grokheavy:default (grokheavy): healthy, last used never
  ✅ xai:default (xai): healthy, last used 10.9h ago
  ✅ LLM timeout: 180s (good — fast failover)
  ⚠️  45 LLM timeouts in recent logs
...
2. [STABILITY] Frequent LLM timeouts detected (45) — may indicate provider issues or overloaded API
3. [SECURITY] 3 high-severity Dependabot alerts — review and patch

---
*Generated by OpenClaw Daily Smoke Test v1.0 at 2026-04-04 05:50:28 PDT*
