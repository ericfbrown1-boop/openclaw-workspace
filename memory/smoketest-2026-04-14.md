...
**Run:** 2026-04-14 05:30:06 PDT
**Host:** MacBook-Pro.localdomain

## 1. Gateway Health

  Installed: OpenClaw 2026.4.12 (1c0672b)
  Latest available: 2026.4.12
  ✅ OpenClaw is up to date
  ✅ Gateway process running (pid 85179)
...
## 6. LLM Provider Health
  ...
  ⚠️  108 LLM timeouts in recent logs
...
## 7. Agent Configuration
  ...
  ✅ researcher: anthropic/claude-opus-4-6 +2 fallbacks workspace=✅
  ✅ planner: anthropic/claude-opus-4-6 +2 fallbacks workspace=✅
  ✅ coder: anthropic/claude-opus-4-6 +2 fallbacks workspace=✅
  ✅ quality: xai/grok-4.20 +2 fallbacks workspace=✅
  ...
  ⚠️  rca-agent: codex/gpt-5.4 (NO fallbacks) workspace=✅
  ✅ tester: anthropic/claude-sonnet-4-6 +1 fallbacks workspace=✅
  ✅ librarian: anthropic/claude-sonnet-4-6 +1 fallbacks workspace=✅

## 8. LaunchAgent Services

  ✅ com.openclaw.librarian.weekly (exit=0, pid=-)
  ✅ com.openclaw.tailscale.monitor (exit=0, pid=-)
  ✅ com.openclaw.batteryguard (exit=0, pid=-)
  ✅ com.openclaw.heartbeat (exit=0, pid=-)
  ✅ com.openclaw.obsidian.sync (exit=0, pid=-)
  ✅ ai.openclaw.gateway (exit=0, pid=85179)
  ✅ com.openclaw.weeklysecurity (exit=0, pid=-)
  ✅ com.openclaw.logrotation (exit=0, pid=-)
  ✅ com.openclaw.gatewaywatchdog (exit=0, pid=-)
  ✅ com.openclaw.caffeinate (exit=0, pid=714)
  ✅ com.openclaw.selfheal (exit=0, pid=-)
  ✅ com.openclaw.sessionmonitor (exit=0, pid=-)
...
**📝 Modified:**
- `main/AGENTS.md` — updated 2026-04-14 03:42 (256 lines)
- `main/skills/auditor/SKILL.md` — updated 2026-04-13 21:49 (105 lines)
- `monitor/skills/auditor/SKILL.md` — updated 2026-04-13 21:49 (105 lines)

**🆕 Newly tracked:**
- `main/skills/rca-agent/SKILL.md`
- `monitor/skills/rca-agent/SKILL.md`

  ⚠️  Agent configuration files have been modified since last check

## Summary

**Health Score: 76/100** (19/25 checks passed, 6 warnings, 0 failures)
...
4. [STABILITY] Frequent LLM timeouts detected (108) — may indicate provider issues or overloaded API
5. [SECURITY] 3 high-severity Dependabot alerts — review and patch
6. [AGENTS] Review agent configuration changes in the Agent Skills section above

---
*Generated by OpenClaw Daily Smoke Test v1.0 at 2026-04-14 05:30:15 PDT*
