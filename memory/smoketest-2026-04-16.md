...
**Run:** 2026-04-16 05:30:06 PDT
**Host:** MacBook-Pro.localdomain

## 1. Gateway Health

  Installed: OpenClaw 2026.4.14 (323493f)
  Latest available: 2026.4.14
  ✅ OpenClaw is up to date
  ✅ Gateway process running (pid 31560)
...
## 6. LLM Provider Health
  ...
  ⚠️  46 LLM timeouts in recent logs
...
## 8. LaunchAgent Services
  ...
  ✅ ai.openclaw.gateway (exit=0, pid=31560)
...
4. [STABILITY] Frequent LLM timeouts detected (46) — may indicate provider issues or overloaded API
...
---
*Generated by OpenClaw Daily Smoke Test v1.0 at 2026-04-16 05:30:14 PDT*
