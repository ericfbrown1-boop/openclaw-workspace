...
## 1. Gateway Health
  ...
  ✅ Gateway process running (pid 96458)
...
## 2. Tailscale Connectivity ⚡
  ...
  Peers:
    ...
    localhost: 100.86.157.19 (⚪ offline)
...
## 3. Telegram Bot Health ⚡
  ...
  ✅ Telegram bot responding (1001ms)
...
## 6. LLM Provider Health
  ...
  ✅ openai:default (openai): healthy, last used 272.0h ago
  ✅ grokheavy:default (grokheavy): healthy, last used never
  ✅ xai:default (xai): healthy, last used 216.0h ago
  ✅ LLM timeout: 180s (good — fast failover)
  ⚠️  10 LLM timeouts in recent logs

## 7. Agent Configuration

  Agents: 8
  ✅ main: anthropic/claude-opus-4-6 +3 fallbacks workspace=✅
  ✅ researcher: anthropic/claude-opus-4-6 +1 fallbacks workspace=✅
...
## 8. LaunchAgent Services
  ...
  ✅ ai.openclaw.gateway (exit=0, pid=96458)
...
1. [STABILITY] Frequent LLM timeouts detected (10) — may indicate provider issues or overloaded API
...
---
*Generated by OpenClaw Daily Smoke Test v1.0 at 2026-03-17 06:43:59 PDT*
