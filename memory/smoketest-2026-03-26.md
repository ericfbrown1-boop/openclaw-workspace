...
## 1. Gateway Health
  ...
  ✅ Gateway process running (pid 91100)
...
## 6. LLM Provider Health
  ...
  ✅ openai:default (openai): healthy, last used 42.6h ago
  ✅ grokheavy:default (grokheavy): healthy, last used never
  ✅ xai:default (xai): healthy, last used 18.5h ago
  ✅ LLM timeout: 180s (good — fast failover)
  ✅ Minor LLM timeouts: 2 (within normal range)
...
## 8. LaunchAgent Services
  ...
  ✅ ai.openclaw.gateway (exit=0, pid=91100)
