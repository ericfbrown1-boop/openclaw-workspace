...
## 1. Gateway Health
  ...
  ✅ Gateway process running (pid 85209)
...
## 6. LLM Provider Health
  ...
  ✅ openai:default (openai): healthy, last used 53.8h ago
  ...
  ⚠️  14 LLM timeouts in recent logs
...
## 8. LaunchAgent Services
  ...
  ✅ ai.openclaw.gateway (exit=0, pid=85209)
...
2. [STABILITY] Frequent LLM timeouts detected (14) — may indicate provider issues or overloaded API
3. [SECURITY] 3 high-severity Dependabot alerts — review and patch

---
*Generated by OpenClaw Daily Smoke Test v1.0 at 2026-03-30 05:30:13 PDT*
