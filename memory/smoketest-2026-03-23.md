...
**Run:** 2026-03-23 05:30:12 PDT
**Host:** Mac

## 1. Gateway Health

  Installed: OpenClaw 2026.3.13 (61d171a)
  Latest available: 2026.3.22
  ⚠️  Update available: 2026.3.13 → 2026.3.22
  ✅ Gateway process running (pid 12827)
...
## 7. Agent Configuration
  ...
  ✅ qwen-local: ollama-local/qwen3.5:35b-a3b +2 fallbacks workspace=❌ MISSING

## 8. LaunchAgent Services

  ✅ com.openclaw.tailscale.monitor (exit=0, pid=-)
  ✅ ai.openclaw.gateway (exit=0, pid=12827)
...
1. [UPDATE] Run: npm install -g openclaw@latest (current: 2026.3.13, available: 2026.3.22)
2. [STABILITY] Frequent LLM timeouts detected (12) — may indicate provider issues or overloaded API
3. [SECURITY] 3 high-severity Dependabot alerts — review and patch

---
*Generated by OpenClaw Daily Smoke Test v1.0 at 2026-03-23 05:30:20 PDT*
