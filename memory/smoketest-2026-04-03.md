...
**Run:** 2026-04-03 05:30:20 PDT
**Host:** Mac

## 1. Gateway Health

  Installed: OpenClaw 2026.4.1 (da64a97)
  Latest available: 2026.4.2
  ⚠️  Update available: 2026.4.1 → 2026.4.2
  ✅ Gateway process running (pid 99738)
...
## 3. Telegram Bot Health ⚡
  ...
  ✅ Telegram bot responding (1012ms)
...
## 6. LLM Provider Health
  ...
  ✅ anthropic:default (anthropic): healthy, last used 12.4h ago
  ✅ openai:default (openai): healthy, last used 149.8h ago
  ✅ grokheavy:default (grokheavy): healthy, last used never
  ✅ xai:default (xai): healthy, last used 0.5h ago
  ✅ LLM timeout: 180s (good — fast failover)
  ⚠️  68 LLM timeouts in recent logs
...
## 8. LaunchAgent Services
  ...
  ✅ ai.openclaw.gateway (exit=0, pid=99738)
...
**🆕 Newly tracked:**
- `main/skills/linkedin-carousel/SKILL.md`
...
1. [UPDATE] Run: npm install -g openclaw@latest (current: 2026.4.1, available: 2026.4.2)
2. [MCP] Check Zapier MCP connection — run: mcporter list
3. [STABILITY] Frequent LLM timeouts detected (68) — may indicate provider issues or overloaded API
4. [SECURITY] 3 high-severity Dependabot alerts — review and patch

---
*Generated by OpenClaw Daily Smoke Test v1.0 at 2026-04-03 05:30:28 PDT*
