...
**Run:** 2026-04-12 05:30:10 PDT
**Host:** MacBook-Pro.localdomain

## 1. Gateway Health

  Installed: OpenClaw 2026.4.10 (44e5b62)
  Latest available: 2026.4.11
  ⚠️  Update available: 2026.4.10 → 2026.4.11
  ✅ Gateway process running (pid 68726)
...
## 6. LLM Provider Health
  ...
  ⚠️  98 LLM timeouts in recent logs
...
## 8. LaunchAgent Services
  ...
  ✅ ai.openclaw.gateway (exit=0, pid=68726)
...
1. [UPDATE] Run: npm install -g openclaw@latest (current: 2026.4.10, available: 2026.4.11)
...
5. [STABILITY] Frequent LLM timeouts detected (98) — may indicate provider issues or overloaded API
...
---
*Generated by OpenClaw Daily Smoke Test v1.0 at 2026-04-12 05:30:18 PDT*
