...
**Run:** 2026-04-02 05:30:06 PDT
**Host:** Mac

## 1. Gateway Health

  Installed: OpenClaw 2026.3.28 (f9b1079)
  Latest available: 2026.4.1
  ⚠️  Update available: 2026.3.28 → 2026.4.1
  ✅ Gateway process running (pid 15507)
  ✅ Gateway HTTP health check passed (HTTP 200)

## 2. Tailscale Connectivity ⚡

  State: Running
  Self: powerspecpc (100.101.203.113)
  Online: True
  Peers:
...
## 6. LLM Provider Health
  ...
  ✅ anthropic:default (anthropic): healthy, last used 5.5h ago
  ✅ openai:default (openai): healthy, last used 125.8h ago
  ✅ grokheavy:default (grokheavy): healthy, last used never
  ✅ xai:default (xai): healthy, last used 69.1h ago
...
## 8. LaunchAgent Services
  ...
  ✅ ai.openclaw.gateway (exit=0, pid=15507)
...
**🆕 Newly tracked:**
- `main/skills/ragflow-search/SKILL.md`
...
1. [UPDATE] Run: npm install -g openclaw@latest (current: 2026.3.28, available: 2026.4.1)
2. [MCP] Check Zapier MCP connection — run: mcporter list
3. [STABILITY] Frequent LLM timeouts detected (46) — may indicate provider issues or overloaded API
4. [SECURITY] 3 high-severity Dependabot alerts — review and patch

---
*Generated by OpenClaw Daily Smoke Test v1.0 at 2026-04-02 05:30:14 PDT*
